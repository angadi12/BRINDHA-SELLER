    ...
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
            <div className="flex justify-between items-center">
              <div className="space-y-2">
                ...
                <div className="bg-teal-600 text-white px-4 py-2 rounded-full inline-flex items-center">
                  <span className="mr-2">📦</span> Estimated Delivery: 27-03-2025
                </div>
              </div>
              <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-md">Cancel Order</button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <div className="relative">
              ...
              <div className="h-1 bg-gray-200 absolute top-5 left-7 right-7 z-0">
                <div className="h-1 bg-teal-600 w-[40%]"></div>
              </div>
              ...
              <div className="flex justify-between relative z-10">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-teal-600 flex items-center justify-center text-white mb-2">
                    <svg
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-medium text-gray-800">Product Shipped</p>
          ...
          {/* Product Details */}
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-500 mb-4">PRODUCT DETAILS</h3>
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-semibold text-gray-800 mb-2">Elite Sewing Machine</h4>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    <div className="bg-gray-100 px-4 py-2 rounded-md">Size: Small</div>
                    <div className="bg-gray-100 px-4 py-2 rounded-md">Color: Teal</div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-2">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2 flex justify-between font-semibold">
                ...
                <span className="text-teal-600">$829</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500">This will be a sample address acting as a filler.</p>
              </div>
            </div>
          </div>
        </div>
