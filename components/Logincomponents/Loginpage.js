          ...
          <div className=" h-full flex justify-between flex-col">
            <div className="flex items-start flex-col justify-items-start ">
              <div className="flex items-center gap-2">
                ...
                <Image src={Logoname} alt="brand" className="object-contain" />
              </div>
            ...
            <Image src={themeimage} alt="themeimage" className="object-contain mt-auto" />
        </Card>
            ...
            {activeTab === "login" ? (
              <>
                ...
                >
                  ...
                  <button className="w-full bg-[#106C83] text-white py-2 rounded-md font-medium hover:bg-[#086778] transition duration-200">
                    Login
                  </button>
              ...
              <>
                ...
                {activeTab2 === "business" && (
                  <motion.div   initial={{ opacity: 0, y: 5 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.3 }}
                    key={activeTab2} className="w-full mx-auto md:px-6">
                    ...
                    <form className="space-y-4">
                      ...
                      <div>
                        ...
                        {/* Shipping Address Checkbox - Improved to match design */}
